...
const Login = () => {
  ...
  return (
    <div lassName='h-[calc(100vh - 120px)] flex justify-center items-center'>
      ...
      <p className='align-baseline font-medium mt-4 text-sm'>Haven't an account? Please <Link to="/register" className='text-blue-500 hover:text-blue-700'>Register Here.</Link></p>
